...
export async function GET(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${getBackendApiUrl()}/agent-task/all?${queryString}`, {
      headers: {
...
export async function POST(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${getBackendApiUrl()}/agent-task/create`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        ...(token ? { Authorization: `Bearer ${token}` } : {}),
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${getBackendApiUrl()}/agent-task/delete`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
        ...(token ? { Authorization: `Bearer ${token}` } : {}),
