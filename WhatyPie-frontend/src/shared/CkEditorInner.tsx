...
const CKEditorInner = ({ value, onChange, onReady, placeholder = "Type your message here...", minHeight = "160px" }: any) => {
  ...
  return (
    <div ref={containerRef} style={{ width: "100%", maxWidth: "100%", overflow: "hidden" }} className="rounded-lg overflow-hidden">
      <CKEditor
        editor={ClassicEditor}
        data={value}
        config={{
          licenseKey: "eyJhbGciOiJFUzI1NiJ9..d30mvseP1O5PdU0v9kKLEvB9Y3Fc3tulqxBsj-wShZLK0dgPNhc9orMASeiAzth2EyDZSDaSBBMSJAnHFAPQcA",
          placeholder,
          plugins: PLUGINS,
          toolbar: TOOLBAR,
        }}
