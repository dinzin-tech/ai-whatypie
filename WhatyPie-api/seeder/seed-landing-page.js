  ...
  try {
    ...
    const defaultLandingPage = new LandingPage({
      hero_section: {
        ...
        hero_image: "/uploads/landing/hero_main.png",
        floating_images: [
          { url: "/uploads/landing/floating.png", position: "left-top" },
            { url: "/uploads/landing/floating.png", position: "right-top" },
            { url: "/uploads/landing/floating.png", position: "left-bottom" },
            { url: "/uploads/landing/floating.png", position: "right-bottom" }
          ]
      },
      features_section: {
        badge: "FEATURES",
          ...
          features: [
            {
              ...
              icon: "ai.svg",
              image: "/uploads/landing/feature.png"
            },
            {
              title: "Chat Inbox",
      ...
      platform_section: {
        ...
        title: "One Platform. Infinite Possibilities.",
                  items: [
            {
              ...
              image: "/uploads/landing/platform.png"
            },
            {
              step: 2,
              tagline: "Onboarding",
