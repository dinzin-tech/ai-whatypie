...
const WhatyPie_FOOTER_DEFAULTS = {
    ...
    if (!landingPage) {
      landingPage = new LandingPage({
        hero_section: {
          ...
          hero_image: WhatyPie_LANDING_IMAGES.hero,
          floating_images: [
            { url: WhatyPie_LANDING_IMAGES.floating, position: "left-top" },
            { url: WhatyPie_LANDING_IMAGES.floating, position: "right-top" },
            { url: WhatyPie_LANDING_IMAGES.floating, position: "left-bottom" },
            { url: WhatyPie_LANDING_IMAGES.floating, position: "right-bottom" }
          ]
        },
        features_section: {
          badge: "FEATURES",
          ...
          features: [
            {
              ...
              icon: "ai.svg",
              image: WhatyPie_LANDING_IMAGES.feature
            },
            {
              title: "Chat Inbox",
          ...
          items: [
            {
              ...
              image: WhatyPie_LANDING_IMAGES.platform
            },
            {
              step: 2,
              tagline: "Onboarding",
        ...
        footer_section: {
          ...
          social_links: WhatyPie_FOOTER_DEFAULTS.social_links,
          copy_rights_text: WhatyPie_FOOTER_DEFAULTS.copy_rights_text
        }
      });
