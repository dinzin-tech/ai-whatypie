   ...
   return new Promise(async (resolve, reject) => {
      try {
         ...
         if (logoSource) {
            try {
               ...
               doc.fillColor(primaryColor)
                  .font('Helvetica-Bold')
                  .fontSize(24)
                  .text(settings?.app_name || 'WhatyPie', 50, 40);
            }
         } else {
            doc.fillColor(primaryColor)
               .font('Helvetica-Bold')
         ...
         doc.fillColor(textColor)
            .font('Helvetica')
            .fontSize(10)
            .text(settings?.app_name || 'WhatyPie Service', 310, sectionTop + 30)
            .fillColor(mutedTextColor)
         ...
         doc.fillColor(mutedTextColor)
            ...
            .fontSize(9)
            .text(
               'Thank you for choosing WhatyPie for your WhatsApp marketing needs!',
               50,
               footerY,
