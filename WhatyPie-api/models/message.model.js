...
const messageSchema = new mongoose.Schema({
  ...
  message_type: {
    type: String,
    enum: ['text', 'link', 'image', 'sticker', 'file', 'video', 'poll', 'form', 'system', 'call', 'document', 'audio', 'location', 'interactive', 'template', 'order', 'system_messages', 'reaction', 'unsupported', 'button', 'list', 'contacts', 'unknown'],
    default: 'text'
  },
  file_url: {
    type: String,
