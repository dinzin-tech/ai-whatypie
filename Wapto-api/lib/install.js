...
export function isInstallWizardEnabled() {
  return process.env.ENABLE_INSTALL_WIZARD === 'true';
}

export async function initializeInstaller(app) {
  if (!isInstallWizardEnabled()) {
    console.log('Install wizard disabled (set ENABLE_INSTALL_WIZARD=true to enable)');
    return null;
  }
