...
/** Copy committed WAPTO logo into uploads for API /settings and landing page URLs. */
export async function seedBrandingAssets() {
  if (!BRAND_LOGO) {
    console.warn('seedBrandingAssets: wapto-logo.png missing — skip');
    return;
  }
  ...
  console.log('WAPTO branding assets copied to uploads/attachments and uploads/landing');
}
